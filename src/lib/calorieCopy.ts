...
export const copy = {
  id: {
    ...
    // ---- Home (logged-in landing) ----
    home: {
      uploadTitle: "Upload Foto Makanan",
      uploadSub: "Scan makanan kamu, kalorinya langsung tercatat",
      uploadCta: "Upload / Scan Sekarang →",
      caloriesTitle: "Sisa Kalori Hari Ini",
      caloriesConsumed: "Sudah dimakan",
      caloriesTarget: "Target",
      caloriesRemaining: (n: number) => `${n.toLocaleString("id-ID")} kkal tersisa`,
      caloriesOver: (n: number) => `${n.toLocaleString("id-ID")} kkal melebihi target`,
      fastingTitle: "Intermittent Fasting",
      fastingUnset: "Belum atur jadwal puasa",
      fastingSetupCta: "Atur di my.20fit.id →",
      fastingEating: "Jendela makan terbuka",
      fastingFasting: "Sedang puasa",
      fastingClosesAt: (t: string) => `Tutup jam ${t}`,
      fastingOpensAt: (t: string) => `Buka jam ${t}`,
      fastingOpensTomorrow: (t: string) => `Buka besok jam ${t}`,
      logTitle: "Log Makanan Hari Ini",
      logEmpty: "Belum ada makanan yang di-log hari ini",
      logEmptyCta: "Scan makanan pertamamu →",
      viewFullTracker: "Lihat tracker lengkap →",
      nutrientCalories: "Kalori",
      nutrientProtein: "Protein",
      nutrientCarbs: "Karbohidrat",
      nutrientFat: "Lemak",
      loading: "Memuat ringkasan hari ini…",
    },
  ...
  en: {
    ...
    // ---- Home (logged-in landing) ----
    home: {
      uploadTitle: "Upload a Food Photo",
      uploadSub: "Scan your food, calories logged instantly",
      uploadCta: "Upload / Scan Now →",
      caloriesTitle: "Calories Left Today",
      caloriesConsumed: "Eaten so far",
      caloriesTarget: "Target",
      caloriesRemaining: (n: number) => `${n.toLocaleString("en-US")} kcal left`,
      caloriesOver: (n: number) => `${n.toLocaleString("en-US")} kcal over target`,
      fastingTitle: "Intermittent Fasting",
      fastingUnset: "No fasting schedule set yet",
      fastingSetupCta: "Set up on my.20fit.id →",
      fastingEating: "Eating window open",
      fastingFasting: "Currently fasting",
      fastingClosesAt: (t: string) => `Closes at ${t}`,
      fastingOpensAt: (t: string) => `Opens at ${t}`,
      fastingOpensTomorrow: (t: string) => `Opens tomorrow at ${t}`,
      logTitle: "Today's Food Log",
      logEmpty: "No food logged yet today",
      logEmptyCta: "Scan your first food →",
